...
function Sidebar() {
 ...
 return (
  <aside className="sticky top-0 flex h-screen w-[290px] shrink-0 flex-col overflow-y-auto border-r border-slate-200 bg-white px-5 py-6 custom-scrollbar">
    ...
    <button 
      ...
      className="mt-auto rounded-2xl border border-slate-200 bg-slate-50 px-5 py-4 font-semibold text-slate-700 hover:bg-red-500 hover:text-white"
    >
      Logout
    </button>
  </aside>
