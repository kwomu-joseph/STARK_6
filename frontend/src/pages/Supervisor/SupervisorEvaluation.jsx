                ...
                <div key={log.id} className="rounded-lg border border-gray-200 p-4">
                  ...
                  <div className="mt-4 grid gap-3 md:grid-cols-[2fr_1fr]">
                    <textarea
                      ...
                      className="min-h-28 rounded-lg border border-gray-300 px-3 py-2 outline-none focus:border-red-500"
                    ...
                    <input
                      ...
                      className="h-fit rounded-lg border border-gray-300 px-3 py-2 outline-none focus:border-red-500"
                      disabled={reviewingId === log.id}
                    />
                  </div>
