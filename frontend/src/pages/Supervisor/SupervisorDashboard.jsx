  ...
  return (
    <DashboardLayout title="Supervisor Dashboard">
      <div className="max-w-6xl">
        <div className="mb-6 rounded-lg border-l-4 border-blue-600 bg-white p-6 shadow-md">
        ...
        <div className="rounded-lg bg-gradient-to-r from-indigo-600 via-violet-600 to-blue-500 p-6 text-white shadow-md">
          <h3 className="mb-4 text-lg font-bold">Dashboard Summary</h3>
          <div className="grid grid-cols-3 gap-4">
            <div>
              <p className="text-red-100">Total Logs</p>
              <p className="text-3xl font-bold">{logs.length}</p>
            </div>
            <div>
              <p className="text-red-100">Pending Review</p>
              <p className="text-3xl font-bold">{pendingLogs}</p>
            </div>
            <div>
              <p className="text-red-100">Completion Rate</p>
