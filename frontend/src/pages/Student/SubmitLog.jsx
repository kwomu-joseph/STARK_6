      ...
      <form onSubmit={handleSubmit} className="flex max-w-md flex-col gap-4">
        ...
        <div className="flex gap-3">
          <button
            ...
            disabled={submitting || Boolean(draftError)}
            className="flex-1 rounded-lg border border-blue-500 p-3 font-semibold text-blue-600 disabled:cursor-not-allowed disabled:opacity-70"
          >
          ...
          <button
            type="submit"
            disabled={submitting || Boolean(draftError)}
            className="flex-1 rounded-lg bg-green-500 p-3 text-white disabled:cursor-not-allowed disabled:opacity-70"
          >
