    ...
    <DashboardLayout title="Feedback">
      ...
      >
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full bg-gradient-to-r from-indigo-600 via-violet-600 to-blue-500 text-white py-2 rounded-lg hover:opacity-90 transition disabled:cursor-not-allowed disabled:opacity-70"
        >
