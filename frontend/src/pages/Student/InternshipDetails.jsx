  ...
  return (
    <DashboardLayout title="Internship Details">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        {success ? <div className="rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">{success}</div> : null}
        ...
        <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
              ...
              <form onSubmit={handleSubmit} className="grid gap-4 md:grid-cols-2">
                ...
                <div className="md:col-span-2">
                  <button
                    type="submit"
                    disabled={saving || deleting}
                    className="rounded-xl bg-green-500 px-5 py-3 font-semibold text-white transition hover:bg-green-600 disabled:cursor-not-allowed disabled:opacity-70"
                  >
          ...
          <section className="space-y-6">
                ...
                {fieldMeta.map((field) => {
                  ...
                  <div key={field.key} className="rounded-xl border border-gray-100 p-4">
                    <div className="flex items-start gap-3">
                      <div className="rounded-lg bg-blue-50 p-2 text-indigo-600">
            ...
            <div className="rounded-2xl bg-gradient-to-r from-indigo-600 via-violet-600 to-blue-500 p-6 text-white shadow-sm">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <p className="text-sm uppercase tracking-[0.2em] text-red-100">Placement Status</p>
