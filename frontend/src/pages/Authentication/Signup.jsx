...
function Signup() {
  ...
  return (
     <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-r from-indigo-600 via-violet-600 to-blue-500 py-12 px-4 overflow-y-auto">

      <div className="bg-blue-900 p-10 rounded-2xl shadow-xl w-full max-w-md my-auto">
        ...
        <form onSubmit={handleSignup} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="bg-indigo-700 hover:bg-indigo-500 text-white py-3 rounded-lg font-semibold transition duration-300 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
          >
