      ...
      <div className="space-y-6">
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-xl border border-red-100 bg-white p-5 shadow-sm">
            ...
            <p className="mt-2 text-3xl font-bold text-indigo-600">{students.length}</p>
          </div>

          <div className="rounded-xl border border-red-100 bg-white p-5 shadow-sm">
            <p className="text-sm text-gray-500">Total Supervisors</p>
            <p className="mt-2 text-3xl font-bold text-green-600">{supervisors.length}</p>
          </div>

          <div className="rounded-xl border border-red-100 bg-white p-5 shadow-sm">
            <p className="text-sm text-gray-500">Students Assigned</p>
            <p className="mt-2 text-3xl font-bold text-red-500">{assignedCount}</p>
          </div>
        </div>
                        ...
                        <td className="px-3 py-4">
                          <div className="flex min-w-[250px] gap-2">
                            ...
                            <button
                              ...
                              className="rounded-lg bg-green-500 px-4 py-2 font-semibold text-white transition hover:bg-red-600 disabled:cursor-not-allowed disabled:opacity-60"
                            >
                ...
                {supervisors.map((supervisor) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <span className="rounded-full bg-green-50 px-3 py-1 text-xs font-semibold text-indigo-700">
